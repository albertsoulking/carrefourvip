...
export class Init1748723648258 implements MigrationInterface {
    name = 'Init1748723648258'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`login_activity\` ADD CONSTRAINT \`FK_6ab7239f4c14afacea611ea065f\` FOREIGN KEY (\`adminId\`) REFERENCES \`admins\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`login_activity\` ADD CONSTRAINT \`FK_28aab163e727fb7ddbb9f07c485\` FOREIGN KEY (\`userId\`) REFERENCES \`users\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`users\` CHANGE \`deliveryAddresses\` \`deliveryAddresses\` longtext COLLATE "utf8mb4_bin" NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`orders\` CHANGE \`deliveryAddress\` \`deliveryAddress\` longtext COLLATE "utf8mb4_bin" NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`order_items\` CHANGE \`addons\` \`addons\` longtext COLLATE "utf8mb4_bin" NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`order_items\` CHANGE \`variants\` \`variants\` longtext COLLATE "utf8mb4_bin" NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`categories\` ADD CONSTRAINT \`FK_fe8e7d37475de7eb2f8f83a6da0\` FOREIGN KEY (\`restaurantId\`) REFERENCES \`users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`categories\` ADD CONSTRAINT \`FK_9a6f051e66982b5f0318981bcaa\` FOREIGN KEY (\`parentId\`) REFERENCES \`categories\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`food_items\` CHANGE \`addons\` \`addons\` longtext COLLATE "utf8mb4_bin" NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`food_items\` CHANGE \`variants\` \`variants\` longtext COLLATE "utf8mb4_bin" NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`payment_gateways\` CHANGE \`config\` \`config\` longtext COLLATE "utf8mb4_bin" NULL DEFAULT 'NULL'`);

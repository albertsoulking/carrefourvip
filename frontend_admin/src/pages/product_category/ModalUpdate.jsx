...
export default function ModalUpdate({
    ...
    const handleOnSubmit = async () => {
        ...
        const payload = {
            ...
            isCollect: formData.isCollect,
            imageUrl: imageUrl ?? formData.imageUrl,
            bgImageUrl: bgImageUrl ?? formData.bgImageUrl
        };
    ...
    return (
        <Dialog
            ...
            disablePortal={false}
            aria-labelledby={'update-category-dialog-title'}>
            <DialogTitle
                id={'update-category-dialog-title'}
                sx={{
                    pb: 1,
                    fontSize: '1.5rem',
                    fontWeight: 'bold',
                ...
                <CategoryRounded color={'primary'} /> 编辑分类
            </DialogTitle>

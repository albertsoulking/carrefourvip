...
const getColumns = () => [
    ...
    {
        field: 'adminParent.name',
        headerName: '上级',
        width: 100,
        renderCell: (params) => (
            <Chip
                label={
                    params.row.admin?.parent
                        ? params.row.admin.parent.name
                        : '-'
                }
                size={'small'}
                color={'info'}
    ...
    },
    {
        ...
        renderCell: (params) => (
            <Typography
                fontSize={12}
                noWrap>
                {params.row.admin?.remark}
            </Typography>
        )
    },
    {
        field: 'adminRole.name',
        headerName: '角色类型',
        width: 100,
        renderCell: (params) => (
            <RowRole status={params.row.admin?.role?.name} />
        )
    },
    {
        field: 'type',
